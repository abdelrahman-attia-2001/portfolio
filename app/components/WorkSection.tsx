...
return (
  <section id="work" className="flex flex-col items-center justify-center bg-[#11151c] p-4 pt-40 text-gray-200">
    <div className="max-w-4xl mx-auto w-full">
      ...
      >
        <span className="text-[#64ffda] font-mono text-sm md:text-base mr-3">03.</span>
      ...
      {projects.map((project, idx) => (
        ...
        >
          ...
          >
            <p className="text-[#64ffda] text-sm uppercase tracking-widest mb-2">Featured Project</p>
            <h3 className="text-2xl md:text-3xl font-bold text-gray-100 mb-4">{project.title}</h3>
            ...
            >
              <a href={project.github} target="_blank" className="hover:text-[#64ffda] transition">
                <FiGithub />
              </a>
              <a href={project.live} target="_blank" className="hover:text-[#64ffda] transition">
                <FiExternalLink />
              </a>
            </div>
          </div>
          ...
          <motion.div
            ...
            initial="hidden"
            whileInView="visible"
            transition={{ duration: 0.6, ease: "easeOut", delay: idx * 0.2 + 0.1 }}
            viewport={{ once: true }}
            ...
            <div className="relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-lg">
              ...
              >
                ...
                <div className="flex gap-4 text-xl">
                  ...
                  <a href={project.live} target="_blank" rel="noopener noreferrer" className="hover:text-[#64ffda] transition">
                    <FiExternalLink />
                  </a>
                </div>
              </motion.div>
